...
DEVICE_PROP Device_Property =
  {
    ...
    0,
    ENDP0_PACKAGE_SIZE /*MAX PACKET SIZE*/
  };
...
void Virtual_Com_Port_Reset(void)
{
  ...
  SetEPRxCount(ENDP0,   ENDP0_RX_SIZE);
  SetEPRxValid(ENDP0);
#if 0
  ...
  SetEPRxCount(ENDP1,   ENDP1_RX_SIZE);
  SetEPRxValid(ENDP1);
  ...
  SetEPRxCount(ENDP3,   ENDP3_RX_SIZE);
  SetEPRxValid(ENDP3);
